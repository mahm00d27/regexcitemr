...
The goal of regexcitemr is to make regular expressions more exciting! It
provides convenience functions to make some common tasks with string
manipulation and regular expressions a bit easier.

## Installation

You can install the development version of regexcitemr from
...
That’s exactly what `regexcitemr::str_split_one()` does.
