...
The goal of regexcitemr is to make regular expressions more exciting!
...
You can install the development version of regexcitemr from [GitHub](https://github.com/) with:
